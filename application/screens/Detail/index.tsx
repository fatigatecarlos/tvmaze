...
import { ScrollView, ActivityIndicator, Image, Text, View, TouchableOpacity, ImageBackground } from 'react-native'
...
import { isFavorite,  setFavorite, deleteFavorite } from "../../services/Repository";
    ...
    const TabButton = (title: string, tabId: number) => {
        return (
            <TouchableOpacity onPress={() => changeTab(tabId)}>
                <Text style={[styles.tabTitle, activeTab == tabId ? styles.active : null]}>{title}</Text>
            </TouchableOpacity>
        )
    }
