...
import { ActivityIndicator, Image, Text, View, FlatList, ListRenderItem,  ImageBackground } from 'react-native'
...
const PersonDetailScreen = () => {
    ...
    const navigation = useNavigation<NativeStackNavigationProp<RootStackParamListDetail>>();
    ...
    const renderItem: ListRenderItem<any> = ({ item }) => <SerieCard id={parseInt(item.id)} image={item.image ? item.image.medium : ''} title={item.name} screen={'Details'}/>;
    ...
    return (
        <View style={styles.body}>
            {isLoading ?
                ...
                <>
                    <ImageBackground source={person.detail.image ? {uri: person.detail.image.medium} : require('../../assets/Images/profile.jpg')} >
                        <Image
                           style={styles.tintImage}
                           source={person.detail.image ? {uri: person.detail.image.medium} : require('../../assets/Images/profile.jpg')} 
                        />
                    </ImageBackground>
